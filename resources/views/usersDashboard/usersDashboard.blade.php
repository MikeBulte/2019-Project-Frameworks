                    ...
                    <div class="selection-outer">
                        <div class="selection-inner d-flex flex-column justify-content-center">
                            <svg class="selection-img" width="90" height="100">
                                <path id="settings_icon" d="M73,56H48V81H73ZM68,1V11H28V1H18V11H13A9.955,9.955,0,0,0,3.05,21L3,91a10,10,0,0,0,10,10H83A10.029,10.029,0,0,0,93,91V21A10.029,10.029,0,0,0,83,11H78V1ZM83,91H13V36H83Z" transform="translate(-3 -1)"/>
                            </svg>
                ...
                <div class="col selection-col">
                    <div class="selection-outer">
                        <div class="selection-inner">
                            ...
                            <h2 class="selection-title">Profiel instellingen</h2>
                        </div>
                    </div>
                </div>
            </div>
